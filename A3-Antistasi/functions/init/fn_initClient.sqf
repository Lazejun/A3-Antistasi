...
if (hasBWMOD) then {
	_textX = _textX + ["BWMOD Detected\n\nAntistasi detects BWMOD in the server config.\nNato Units will be Bundeswehr Units."];
};

if (hasTFAR or hasACE or hasRHS or hasACRE or hasFFAA or hasBWMOD) then {
	[_textX] spawn {
		sleep 0.5;
